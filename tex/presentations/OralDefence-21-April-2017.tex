...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Verbs without prepositional prefixes (e.g., \textit{gav} `give'):
		\begin{itemize}
		...
		\end{itemize}
	\item Verbs with prepositional prefixes (e.g., \textit{er-bjod} `offer'):
		\begin{itemize}
