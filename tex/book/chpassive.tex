...
\trans `I believe that the children were given the bicycle.'\pagebreak}
...
\begin{exe}
	\ex Icelandic, Topicalisation:\label{ex:ice-topic}
\begin{xlist}
...
\begin{exe}
	\ex Icelandic, Ditransitive Topicalisation:\label{ex:ice-dittop}
\begin{xlist}
