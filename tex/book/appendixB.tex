...
\begin{exe}
	\exr{ex:nor-null-incorp} Standard Norwegian:
		...
		\trans `He was given a medal.'\pagebreak
...
\begin{exe}
	...
	\exr{ex:hg-rt} High German:
		...
		\trans `as he gives dishonesty no opportunity \citep[162]{Draye.1996}.'\pagebreak
	...
	\exr{ex:hg-VPadverb} High German, VP-level adverbs:
		\begin{xlist}
			...
			\trans `I didn't give the man the book, instead I sent the woman the film.'\pagebreak
