...
This subsection showed that High German provides solid language internal evidence that theme--recipient word orders are derived via scrambling from recipient--theme orders. This scrambling targets a position within the verb phrase. Since the operation is necessary to account for the High German data, the most parsimonious account of theme--recipient orders in other languages would use the same operation.
