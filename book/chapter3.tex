...
\begin{exe}
	\ex German:
	\begin{xlist}
		\ex[\#]{\gll Ich weiss, dass er \textbf{Maria} einen Brief geschickt hat, aber er ist bei ihr nicht angekommen\\
		I.NOM know, that he.NOM \textbf{Maria} a.ACC letter sent has, but he.NOM is by her.DAT not arrived\\
\trans `I know that he sent Maria a letter, but it has not reached her.'}
\ex[\#]{\gll Ich weiss, dass er einen Brief \textbf{Maria} geschickt hat, aber er ist bei ihr nicht angekommen\\
		I.NOM know, that he.NOM a.ACC letter \textbf{Maria} sent has, but he.NOM is by her.DAT not arrived\\
\trans `I know that he sent a letter to Maria, but it has not reached her.'}
\ex[ ]{\gll Ich weiss, dass er einen Brief \textbf{an} \textbf{Maria}  geschickt hat, aber er ist bei ihr nicht angekommen\\
I.NOM know, that he.NOM a.ACC letter \textbf{to} \textbf{Maria} sent has, but he.NOM is by her.DAT not arrived\\
\trans `I know that he sent a letter to Maria, but it has not reached her.'}
	\end{xlist}
\end{exe}
...
The typical word order for recipients in Romance languages is theme--recipient.
