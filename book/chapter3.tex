...
\section{Morphology and Dative Marking}
	...
	\begin{exe}
		\ex English, Accusative-to-genitive in nominalisation (Non-recipient):
		\begin{xlist}
			\ex John kissed Mary.
			\ex John's kissing of Mary\ldots
		\end{xlist}
		\ex English, Accusative-to-genitive in nominalisation (Recipient):
		\begin{xlist}
	...
	\begin{exe}
		\ex English, Recipients in nominalisation:
		\begin{xlist}
			\ex[ ]John gave Mary a book.
