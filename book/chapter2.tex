...
\begin{exe}
	\ex Standard German:
	\begin{xlist}
		\ex Ich habe den Mann gesehen\\
		I.NOM have the.\textbf{ACC} man seen\\
		\trans `I saw the man.'
		\ex Der Mann wurde gesehen\\
