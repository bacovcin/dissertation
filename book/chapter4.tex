...
\caption{LOESS lines for \textit{to} use in Modern American theme--recipient actives (with pronominal recipients) and theme passives.\label{fig:amdata}}\label{fig:amtoset-graph}
\end{figure}
