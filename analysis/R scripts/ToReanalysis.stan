...
model {
  ...
  // Non-interaction intercept and slope have larger SD
  Int1 ~ cauchy(0,4);
  Slope1 ~ cauchy(0,4);
  Slope2 ~ cauchy(0,4);
  
  // Interactions have half the SD of main effects
  ProInt1 ~ cauchy(0,2);
  ProSlope1 ~ cauchy(0,2);
  RTInt1 ~ cauchy(0,2);
  RTSlope1 ~ cauchy(0,2);
  ProRTInt1 ~ cauchy(0,2);
  ProRTSlope1 ~ cauchy(0,2);
  Slope2 ~ cauchy(0,2);
  ProSlope2 ~ cauchy(0,2);
