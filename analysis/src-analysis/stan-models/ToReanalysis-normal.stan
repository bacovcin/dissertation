...
model {
  ...
  ProInt1 ~ normal(0,priorSD);
  ProSlope1 ~ normal(0,priorSD);
  RTInt1 ~ normal(0,priorSD);
  RTSlope1 ~ normal(0,priorSD);
  ProRTInt1 ~ normal(0,priorSD);
  ProRTSlope1 ~ normal(0,priorSD);
  Slope2 ~ normal(0,priorSD);
  ProSlope2 ~ normal(0,priorSD);
