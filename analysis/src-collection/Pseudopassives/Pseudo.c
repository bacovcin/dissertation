...
ACT: (CP* iDoms IP-MAT*|IP-SUB*) AND (IP-MAT*|IP-SUB* iDoms V*) AND (V* iDomsMod META|LEMMA account|agree|approve|arrive|call|complain|dispose|enter|hear|hit|look|meet|pray|provide|put|say|send|seek|speak|wish) AND (IP-MAT*|IP-SUB* iDomsMod PP P) AND (P iDomsMod META|LEMMA for|on|upon|of|at|about|into|with|after) AND (V* iPres PP)
