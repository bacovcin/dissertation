...
13: {
   ...
   AccDat: (CP* iDoms IP*) AND (IP* iDoms PP) AND (PP iDomsMod PP|CONJ* P) AND (P iDomsMod META|LEMMA ditp) AND (IP* iDoms acc) AND (acc Pres PP)
   DatAcc: (CP* iDoms IP*) AND (IP* iDoms PP) AND (PP iDomsMod PP|CONJ* P) AND (P iDomsMod META|LEMMA ditp) AND (IP* iDoms acc) AND (PP Pres acc)
   NA: ELSE
}
